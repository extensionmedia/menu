...
@section('content')
    ...
    <div class="border rounded-lg overflow-hidden my-4">
        <div class="bg-gray-100 py-2 px-4 text-gray-800 text-sm">
            <i class="fas fa-plus"></i> Creer un compte
            @php
                $folder = 'users/'.$UID
            @endphp
        </div>
        <form method="POST" action="{{route('user.store')}}" class="bg-white py-8 px-4">
            @if($errors->any())
            ...
            <div class="text-gray-600 text-xs flex items-center mb-4">
                ...
                <input value="{{old('email')}}" required class="border rounded py-1 px-2 text-sm flex-1" type="email" name="email" placeholder="email">
            </div>

            <div class="text-gray-600 text-xs flex items-center mb-4">
                <div class="w-32">Password</div>
                <input value="{{old('password')}}" required class="border rounded py-1 px-2 text-sm flex-1" type="password" name="password" placeholder="*****">
            </div>

            <div class="text-gray-600 text-xs flex items-center mb-4">
                <div class="w-32">Confirm Password</div>
                <input value="{{old('password_confirmation')}}" required class="border rounded py-1 px-2 text-sm flex-1" type="password" name="password_confirmation" placeholder="*****">
            </div>
